...
const getSubhead = (e) => {
  ...
  const dept="e.target.value;";    setFormData({
  ...formData,      department:e.target.value,
});    // Dispatch to Redux    dispatch(subheadList({
  budgetHead:formData.budgetHead,financialYear:formData.financialYear,department:dept
}))      .then((response) => {
...
const handleSubmit = (e) => {
  ...
  id:formData.budgetHead_id,budgetSubhead:formData.budgetSubhead,financialYear:formData.financialYear,department:formData.department,amount:formData.amount
  ...
  { marginLeft: "0", marginRight: "0", maxWidth: "75%"
}}        >
    <form onSubmit="{"
  handleSubmit
}>
