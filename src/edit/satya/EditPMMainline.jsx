...
import React, {
  ...
  ...formValues, [workKey]: updatedWorkArray
});
  ...
  ...formValues, [workKeys]: updatedWorkArray
});
  ...
  ...formValues, [workKeyss]: updatedWorkArray
});
  ...
  { marginLeft: "0", marginRight: "0", maxWidth: "100%"
}}          >
    <form onSubmit="{"
  handleSubmit
}>
  ...
  { textAlign: "left"
    ...
    <label className="col-md-9" style="{"
  { textAlign: "center"
}}>                  SC                </label>
    <label className="col-md-6" style="{"
  { textAlign: "center"
}}>                  Remarks                </label>
    <label className="col-md-3" style="{"
  { textAlign: "center"
}}>                  Action Taken                </label>
    <label className="col-md-7" style="{"
  { textAlign: "center"
}}>                  Deficiency                </label>
    </div>              {
  ...
  {width:"100px", height: "50px", textAlign: "center"
}}>                  Save                </button>
    </div>
    </form>
    </div>
  ...
  { textAlign: "left", flex: "none", width: "fit-content"
  ...
  formValues[workKey][index][g] === "✔"
}                  onChange="{"
  () => handleInputChange(workKey, index, g)
}                />
    <label>{
  g
}</label>
    ...
    <div className="col-md-4">
    <input              type="text"              className="form-control"              value="{"
  formValues[workKey][index].remark
}              onChange="{"
  (e) =>                handleInputChange(workKey, index, "remark", e.target.value)
    ...
    <div className="col-md-4">
    <input              type="text"              className="form-control"              value="{"
  formValues[workKey][index].action
}              onChange="{"
  (e) =>                handleInputChange(workKey, index, "action", e.target.value)
    ...
    <div className="col-md-4">
    <input              type="text"              className="form-control"              value="{"
  formValues[workKey][index].deficiency
}              onChange="{"
  ...
  formValues[workKeys][indexs][c] === "✔"
}                  onChange="{"
  () => handleInputChanges(workKeys, indexs, c)
}                />
    <label>{
  c
}</label>
    ...
    <input              type="text"              className="form-control"              value="{"
  formValues[workKeys][indexs].remark1
}              onChange="{"
  (e) =>                handleInputChanges(workKeys, indexs, "remark1", e.target.value)
    ...
    <div className="col-md-3">
    <input              type="text"              className="form-control"              value="{"
  formValues[workKeys][indexs].action1
}              onChange="{"
  (e) =>                handleInputChanges(workKeys, indexs, "action1", e.target.value)
    ...
    <div className="col-md-4">
    <input              type="text"              className="form-control"              value="{"
  formValues[workKeys][indexs].deficiency1
}              onChange="{"
  (e) =>                handleInputChanges(                  workKeys,                  indexs,                  "deficiency1",                  e.target.value                )
}            />
    </div>
  ...
  formValues[workKeyss][indexss][s] === "✔"
}                  onChange="{"
  () => handleInputChangess(workKeyss, indexss, s)
}                />
    <label>{
  s
}</label>
    ...
    <div className="col-md-4">
    <input              type="text"              className="form-control"              value="{"
  formValues[workKeyss][indexss].remark2
}              onChange="{"
  (e) =>                handleInputChangess(                  workKeyss,                  indexss,                  "remark2",                  e.target.value                )
}            />
    </div>
    <div className="col-md-3">
    <input              type="text"              className="form-control"              value="{"
  formValues[workKeyss][indexss].action2
}              onChange="{"
  (e) =>                handleInputChangess(                  workKeyss,                  indexss,                  "action2",                  e.target.value                )
}            />
    </div>
    <div className="col-md-4">
    <input              type="text"              className="form-control"              value="{"
  formValues[workKeyss][indexss].deficiency2
}              onChange="{"
  (e) =>                handleInputChangess(                  workKeyss,                  indexss,                  "deficiency2",                  e.target.value                )
}            />
    </div>
