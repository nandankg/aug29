...
import {
  ...
  { marginLeft: "0", marginRight: "0", maxWidth: "90%"
}}>
    <form onSubmit="{"
  handleSubmit
}>
  ...
  (e) =>                    setFormValues({
  ...formValues, stn_name: e.target.value
})
}                  required                >
  ...
  (e) =>                                            setFormValues({
  ...formValues, month: e.target.value
})
}                                    >
  ...
  { textAlign: "left"
    ...
    <label className="col-md-14" style="{"
  { textAlign: "right"
}}>EC</label>
  ...
  c
    ...
    <div className="col-md-3">
    <input              type="text"              className="form-control"              value="{"
  formValues[workKeys][indexs].remarks
}              onChange="{"
  (e) =>                handleInputChanges(workKeys, indexs, "remarks", e.target.value)
    ...
    <div className="col-md-3">
    <input              type="text"              className="form-control"              value="{"
  formValues[workKeys][indexs].actions
}              onChange="{"
