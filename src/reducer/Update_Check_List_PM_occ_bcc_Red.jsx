import {
  ...
  addUpdatePMOccBcc: (state, action) => {
  ...
  addUpdatePMOccBcc
} = Update_Check_List_PM_occ_bcc_Slice.actions;export default Update_Check_List_PM_occ_bcc_Slice.reducer;