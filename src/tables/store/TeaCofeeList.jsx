...
const TeaCofeeList = () => {
  ...
  const columns = [
    { field: 'sno', headerName: 'S_No' },
    { field: 'item', headerName: 'ITEM' },
    { field: 'quantity', headerName: 'Quantity In' },
    { field: 'datein', headerName: 'Date In' },
    { field: 'quantityOut', headerName: 'Quantity Out' },
    { field: 'dateout', headerName: 'Date Out' },
        ...
        <div className="d-flex justify-content-between">
          ...
          <div className="d-flex gap-3">
            ...
            <UniversalExportComponent
              ...
              columns={columns}
              exportType="both"
              formName="Tea/Coffee List"
              formId="tea-coffee-list"
              template="standard"
