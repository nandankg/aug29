...
import { fetchData } from "../../reducer/store/BudgetRegisterPaymentReducer";
import dayjs from "dayjs";
import ReusableFilterBar from "../../component/ReusableFilterBar";
import TableStructurePayment from "../../component/TableStructurePayment";
import Pagination from "../../component/Pagination";
import { filterTableData } from "../../utils/tableUtils";
import { budgetpayments } from "../../data/tableColumns";
...
const BudgetRegisterPayment = () => {
  ...
  const attendance = useSelector((state) => state.budgetpayment);
  ...
  return (
    <div className="container mt-5">
      ...
      {/* Table Structure */}
      <TableStructurePayment
        columns={budgetpayments}
      ...
      <div style={{ display: 'flex', gap: '10px', marginBottom: '10px' }}>
        <UniversalExportComponent
          ...
          columns={budgetpayments}
          exportType="both"
          formName="Budget Register Payment"
          formId="budget-register-payment"
          template="standard"
