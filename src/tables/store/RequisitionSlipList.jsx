...
const RequisitionSlipList = () => {
  ...
  const exportColumns = [
    ...
    { field: 'demandedQuantity', headerName: 'Demanded Quantity' },
    { field: 'issuedQuantity', headerName: 'Issued Quantity' },
    { field: 'dtrPageNo', headerName: 'DTR Page No' },
  ...
  useEffect(() => {
    ...
    if (formValues.items && formValues.items.length > 0) {
      const filtItem = formValues.items.filter((item) =>
      ...
      <div className="d-flex align-items-center gap-3 mt-3">
        <div className="d-flex gap-3">
          ...
          <UniversalExportComponent
            ...
            exportType="pdf"
            formName="Requisition Slip"
            formId="requisition-slip"
            template="standard"
            ...
            metadata={{
              ...
              slipNumber: formValues.book_no,
              department: formValues.department,
              station: formValues.station,
              sectionIncharge: formValues.section_incharge,
              issuedBy: formValues.issued_name,
              receiverName: formValues.receiver_name,
              approvedBy: formValues.approved_by
            }}
          />
        </div>
      </div>
