...
const handleSave = () => {
  ...
  item.shiftTiming
    ...
    <thead>
    <tr> {
  /* New row for opening stock headers */
    ...
    <tr> {
  /* New row for opening stock values */
}             {
  /* Empty space */
}            <th>SV</th>
    <th>SSC</th>
  ...
  item.openingStock[0].SV
}</td> {
  /* Opening Stock SV */
}              <td>{
  item.openingStock[0].SSC
}</td> {
  /* Opening Stock SSC */
}              <td>{
  item.openingStock[0].BL
}</td> {
  /* Opening Stock BL */
}              <td>{
  item.openingStock[0].T1
}</td> {
  /* Opening Stock T1 */
}              <td>{
  item.openingStock[0].T3
}</td> {
  /* Opening Stock T3 */
}              <th colSpan="2">Fresh</th>
    <td>{
  item.closingStock[0].SV
}</td> {
  /* Closing Stock SV */
}              <td>{
  item.closingStock[0].SSC
}</td> {
  /* Closing Stock SSC */
}              <td>{
  item.closingStock[0].BL
}</td> {
  /* Closing Stock BL */
}              <td>{
  item.closingStock[0].T1
}</td> {
  /* Closing Stock T1 */
}              <td>{
  item.closingStock[0].T3
}</td> {
  /* Closing Stock T3 */
}            </tr>
    <tr>              {
  ...
  item.openingStock[1].SV
}</td> {
  /* Opening Stock SV */
}              <td>{
  item.openingStock[1].SSC
}</td> {
  /* Opening Stock SSC */
}              <td>{
  item.openingStock[1].BL
}</td> {
  /* Opening Stock BL */
}              <td>{
  item.openingStock[1].T1
}</td> {
  /* Opening Stock T1 */
}              <td>{
  item.openingStock[1].T3
}</td> {
  /* Opening Stock T3 */
}              <th colSpan="2">Deface </th>
    <td>{
  item.closingStock[1].SV
}</td> {
  /* Closing Stock SV */
}              <td>{
  item.closingStock[1].SSC
}</td> {
  /* Closing Stock SSC */
}              <td>{
  item.closingStock[1].BL
}</td> {
  /* Closing Stock BL */
}              <td>{
  item.closingStock[1].T1
}</td> {
  /* Closing Stock T1 */
}              <td>{
  item.closingStock[1].T3
}</td> {
  /* Closing Stock T3 */
}            </tr>
    <tr>              {
  ...
  item.openingStock[2].SV
}</td> {
  /* Opening Stock SV */
}              <td>{
  item.openingStock[2].SSC
}</td> {
  /* Opening Stock SSC */
}              <td>{
  item.openingStock[2].BL
}</td> {
  /* Opening Stock BL */
}              <td>{
  item.openingStock[2].T1
}</td> {
  /* Opening Stock T1 */
}              <td>{
  item.openingStock[2].T3
}</td> {
  /* Opening Stock T3 */
}              <th colSpan="2">Defective   </th>
    <td>{
  item.closingStock[2].SV
}</td> {
  /* Closing Stock SV */
}              <td>{
  item.closingStock[2].SSC
}</td> {
  /* Closing Stock SSC */
}              <td>{
  item.closingStock[2].BL
}</td> {
  /* Closing Stock BL */
}              <td>{
  item.closingStock[2].T1
}</td> {
  /* Closing Stock T1 */
}              <td>{
  item.closingStock[2].T3
}</td> {
  /* Closing Stock T3 */
}            </tr>
    </>
  ...
  /* Important: Add a unique key for each row */
}              <td>{
  index+1
}</td>
    <td>{
