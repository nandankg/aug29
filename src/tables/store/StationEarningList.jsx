...
import { fetchData } from "../../reducer/store/StationEarningReducer";
...
import { stationearning } from "../../data/tableColumns";
...
const StationEarningList = () => {
  const dispatch = useDispatch();
  const [slug, setSlug] = useState(getLastParameter().trim());
  const attendance = useSelector((state) => state.stationearning);
    ...
    <div className="container mt-5">
      ...
      <div style={{ display: 'flex', gap: '10px', marginBottom: '10px' }}>
        <UniversalExportComponent
          ...
          columns={stationearning}
          exportType="both"
          formName="Station Earning List"
          formId="station-earning-list"
          template="standard"
...
export default StationEarningList;