...
import { fetchData } from "../../reducer/store/BudgetAllotmentReducer";
import dayjs from "dayjs";
import ReusableFilterBar from "../../component/ReusableFilterBar";
import TableStructure from "../../component/TableStructureob";
import Pagination from "../../component/Pagination";
import { filterTableData } from "../../utils/tableUtils";
import { budgetallotment } from "../../data/tableColumns";
...
const BudgetAllotmentList = () => {
  ...
  const attendance = useSelector((state) => state.budgetallotment);
    ...
    <div className="container mt-5">
      ...
      <div style={{ display: 'flex', gap: '10px', marginBottom: '10px' }}>
        <UniversalExportComponent
          ...
          columns={budgetallotment}
          exportType="both"
          formName="Budget Allotment List"
          formId="budget-allotment-list"
          template="standard"
