...
import { fetchData } from "../../reducer/isha/EstimateLOAReducer";
import dayjs from "dayjs";
import ReusableFilterBar from "../../component/ReusableFilterBar";
import TableStructureLOA from "../../component/TableStructureLOA";
import Pagination from "../../component/Pagination";
import { filterTableData } from "../../utils/tableUtils";
import { estimateandloabudgetregister } from "../../data/tableColumns";
...
const EstimateLOARegisterList = () => {
  const dispatch = useDispatch();
  const [slug, setSlug] = useState(getLastParameter().trim());
  const attendance = useSelector((state) => state.estimateloa);
  ...
  return (
    <div className="container mt-5">
      ...
      {/* Table Structure */}
      <TableStructureLOA
        columns={estimateandloabudgetregister}
      ...
      <div style={{ display: 'flex', gap: '10px', marginBottom: '10px' }}>
        <UniversalExportComponent
          ...
          columns={estimateandloabudgetregister}
          exportType="both"
          formName="Estimate LOA Register"
          formId="estimate-loa-register"
          template="standard"
...
export default EstimateLOARegisterList;