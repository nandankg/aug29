        ...
        <div className="d-flex justify-content-between">
          <div className="d-flex align-items-center gap-3">
            <div className="d-flex gap-3">
              ...
              {/* Complex Maintenance Export Component */}
              <div style={{ display: 'flex', gap: '10px', marginBottom: '10px' }}>
                <ComplexMaintenanceExportComponent
                  data={filteredData || []}
                  exportType="both"
                  formName="AFC Preventive Maintenance Checklist TOM Half Yearly"
                  formId="afc-preventive-maintenance-checklist-tom-half-yearly"
                  size="medium"
                  showLabel={false}
                />
              </div>
