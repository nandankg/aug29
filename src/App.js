          ...
          <div className="row pt-0">
            ...
            <div className="main-contain">
              <Suspense fallback={<div className="d-flex justify-content-center p-5"><div className="spinner-border" role="status"><span className="sr-only">Loading...</span></div></div>}>
                ...
                <Route path="/form/dtr-issue-store" Component={DtrIssueStore} />
                <Route
                ...
                />
                 <Route
                  path="/form/tsr-register"
                  Component={TSRRegisterForm}
                />
                 <Route
                ...
                />
                <Route path="/form/gate-pass-book-store" Component={GatePass}  />
                <Route
                ...
                <Route path="/form/gate-pass-book" Component={GatePass} />
                ...
                <Route path="/form/cbt-training" Component={CBTTrainingReg} />
                ...
                <Route
                  path="/form/equipment_failure_register"
                   Component={EquipmentFailureRegister}
                />
                <Route
...
<Route
                ...
                <Route path="/form/assurance-register" Component={AssuRegReg} />
                <Route
                ...
                />
                <Route path="/form/bio-data-register"  Component={BioDataRegister} />
                <Route
                ...
                <Route
                  ...
                  Component={EditDailyTransactionRegister_RECEIPTS}
                />
                <Route path="/form/requisition"  Component={RequisitionSignal}  />
                ...
                />
                <Route path="/form/ledger-store" Component={LedgerForm} />
